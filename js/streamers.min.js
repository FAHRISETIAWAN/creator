(()=>{
    ...
    const O = {
        ...
        updateSlides: function() {
            ...
            for (let n = 0; n < p; n += 1) {
                E = 0;
                const r = c.eq(n);
                if (x && e.grid.updateSlide(n, r, p, t),
                "none" !== r.css("display")) {
                    ...
                    f.push(E),
                    i.centeredSlides ? (C = C + E / 2 + y / 2 + b,
                    0 === y && 0 !== n && (C = C - a / 2 - b),
                    0 === n && (C = C - a / 2 - b),
                    Math.abs(C) < .001 && (C = 0),
    ...
    , function(e) {
        ...
        i("init", (()=>{
            !1 === t.params.pagination.enabled ? m() : (u(),
            p(),
            c())
        }
        )),
    ...
    , function(e) {
        ...
        function r() {
            ...
            const s = e.clickedIndex
              , i = e.clickedSlide;
            if (i && f(i).hasClass(t.params.thumbs.slideThumbActiveClass))
                return;
            if (null == s)
                return;
            let n;
            if (n = e.params.loop ? parseInt(f(e.clickedSlide).attr("data-swiper-slide-index"), 10) : s,
            t.params.loop) {
                let e = t.activeIndex;
        ...
        function o(e) {
            ...
            if (t.realIndex !== s.realIndex || a) {
                ...
                if (s.params.loop) {
                    ...
                    r = void 0 === e ? i : void 0 === i ? e : i - o == o - e ? s.params.slidesPerGroup > 1 ? i : o : i - o < o - e ? i : e,
                    l = t.activeIndex > t.previousIndex ? "next" : "prev"
                } else
                    r = t.realIndex,
                    l = r > t.previousIndex ? "next" : "prev";
                a && (r += "next" === l ? n : -1 * n),
                s.visibleSlidesIndexes && s.visibleSlidesIndexes.indexOf(r) < 0 && (s.params.centeredSlides ? r = r > o ? r - Math.floor(i / 2) + 1 : r + Math.floor(i / 2) - 1 : r > o && s.params.slidesPerGroup,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        document.querySelectorAll(".channels_content .swiper").forEach((function(e, t) {
            ne(".swiper_".concat(t + 1), ".swiper_".concat(t + 1, "-nav"), {
                spaceBetween: 30,
                autoplay: {
                    pauseOnMouseEnter: !0,
        ...
        ne(".insights_slider", ".insights_nav", {
            autoplay: !0,
            speed: 1200,
            spaceBetween: 30,
            breakpoints: {
